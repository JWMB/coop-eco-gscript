...
export const someonesBudget = `Konto	2019	2020	Budget 2020	Rel 2020	Namn	Ansvar	Kommentar	Kommentar 2
...
export const konton = `Konto	2018	2019	2020	Budget 2020	Rel 2020	Budget 2021	Namn	Ansvar	Kommentar
45613							N/A		
45640							N/A		
...
export const kontonOld = `Konto	2018	2019	Budget 2019	Rel 2019	Budget 2020	Namn	Ansvar
11820						Pågående om- och tillbyggnad	
12110						N/A	
15210						N/A	
16889						N/A	
...
export const previousCollected = `Konto	Datum	Summa	Mottagare	Kommentar	Kassör
41110		-60,000.00	SBC	Fastighetsskötartjänsten av SBC	Förvaltarkontakt
41150		0.00		Förutses ej: Fastighetsskötsel gård entrep	Utemiljö
41160	27/04/20	-4,750.00	Svenska Trädmästarna	Tömning rishög	Utemiljö
41160	13/10/20	-4,750.00	Svenska Trädmästarna	Tömning rishög	Utemiljö
41160	15/09/20	-5,000.00	Trivselträdgårdar	Parkslide	Utemiljö
41160	15/05/20	-5,000.00	Trivselträdgårdar	Parkslide	Utemiljö
41170	28/12/20	-75,000.00	Svensk Mark	Snöröj mark (JB: ändrat från 50 -> 75)	Utemiljö
41170	28/03/20	-75,000.00	Svensk Mark	Snöröj mark	Utemiljö
41180	12/31/2020	-50,000.00	WJJ Entreprenad (=Fastighetskonsulterna)	Brukar ligga mellan 25 000 och 50 000 beroende på hur hård vintern är.	Tak och plåt
`;